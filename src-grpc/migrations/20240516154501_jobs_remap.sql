...
alter table jobs
add constraint jobs_provider_fkey foreign key (provider) references users(id) on delete cascade,
add constraint jobs_consumer_fkey foreign key (consumer) references users(id) on delete cascade,
